...
- **`system.md`** — **System-owned only.** Canonical workspace paths and a short tail of recent orchestrator/worker activity (from SQLite `run_events`). The lab overwrites this file; **do not edit**.
