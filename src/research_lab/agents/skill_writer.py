...
Turn successful work into reusable skills under `.airesearcher/memory/skills/`.
...
**Workflow**
1. Read `.airesearcher/state/skills_index.md` and existing `.airesearcher/memory/skills/` files.
...
4. Keep Tier A lean: put long examples in `.airesearcher/memory/extended/` and link them.
